...
$category_id = 4; // You can dynamically set this based on user choice or another parameter
    ...
    <div class="categories-bar">
      <div class="categories">
        ...
        <div class="category">
          ...
          <p class="icon-text" style="color: green; font-weight: bold; border-bottom: 2px solid green;">Beverage</p>
        </div>
        <div class="category">
...
<h3 style="text-align: center;font-size: 20px; font-weight: bold; margin: 0 auto; display: block;">
    Recommended
...
<a class="active" href="addproductlist.php">
  <i class="ffa fa-shopping-basket"style="font-size: 24px;"><br>
