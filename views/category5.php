...
<body>
    <header class="navbar" style="width: auto; height: 70px;" data-bs-theme="dark">
        <h1 style="color: darkgreen; font-weight: bold; font-size: 35px; margin-left: 10px;">Seafood Shop</h1>
    ...
    <div class="categories-bar">
        <div class="categories">
            ...
            <div class="category">
                ...
                <p class="icon-text" style="color: green; font-weight: bold; border-bottom: 2px solid green;">Seafoods</p>
            </div>
            <div class="category">
