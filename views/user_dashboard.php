...
$sort = isset($_GET['sort']) ? $_GET['sort'] : 'name'; // Default to 'name'
...
switch ($sort) {
  ...
  case 'price':
      ...
      break;
  case 'store':
      $orderBy = 'Store'; // Assuming 'Store' is a valid column in your product table
      break;
  case 'name':
  default:
      $orderBy = 'Name';
    ...
    <div class="categories-bar">
        <div class="categories">
            <div class="category">
                ...
                <p class="icon-text" style="font-weight: bold; color: green; border-bottom: 2px solid green;">All</p>
            </div>
            <div class="category">
        ...
        <form method="GET" action="" class="d-flex">
            <div class="form-group me-2">
                <select name="sort" class="form-control" onchange="this.form.submit();">
                    <option value="name" <?php echo $sort==='name' ? 'selected' : ''; ?>>Sort by Product Name</option>
                    <option value="category_id" <?php echo $sort==='category_id' ? 'selected' : ''; ?>>Sort by Category</option>
                    <option value="price" <?php echo $sort==='price' ? 'selected' : ''; ?>>Sort by Price</option>
                    <option value="store" <?php echo $sort==='store' ? 'selected' : ''; ?>>Sort by Store</option>
                </select>
            </div>
        </form>
    </div>
