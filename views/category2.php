...
$category_id = 2; // You can dynamically set this based on user choice or another parameter
...
<body>
    <header class="navbar" style="width: auto; height: 70px;" data-bs-theme="dark">
        <h1 style="color: darkgreen; font-weight: bold; font-size: 35px; margin-left: 10px;">Protein Shop</h1>
