...
<header class="navbar nowrap p-0 shadow" style="height: 150px; border: none; background-color: darkgreen;" data-bs-theme="dark">
        <center>
            ...
            <div class="container">
                <p style="font-weight: bold; color: maroon; font-size: 25px; margin-left:115px; margin-top: 15px; text-items: center;"><?php echo htmlspecialchars($users['username']); ?></p>
            </div>
        </center>
    </header>
...
<a href="addproductlist.php" style="text-decoration: none; display: flex; align-items: center; font-weight: bold; margin-bottom:30px;">
    ...
    <span style="color: black; margin-left: 15px;">Shopping&nbsp;List</span>
</a>
<a href="#" style="text-decoration: none; display: flex; align-items: center; font-weight: bold; margin-bottom:30px;">
